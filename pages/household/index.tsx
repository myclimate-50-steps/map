    ...
    <div className={styles.container}>
      ...
      >
        <h1 className="text-6xl text-center mb-6">
          {steps.categories.household[currentActive].title}
        </h1>
        <p className="text-lg text-center break-words">
          {steps.categories.household[currentActive].description}
        </p>
      </div>
      <div
        className={`${
      ...
      >
        <div className="flex justify-center col-start-3">
          <StoryButton
            ...
            color="#4F7EBA"
            text={steps.categories.household[0].title}
            onClick={(): void => {
              toggleStep();
              setActive(0);
            }}
        ...
        <div className="flex justify-center col-start-2">
          <StoryButton
            className="transition-transform hover:scale-125"
            color="#4F7EBA"
            text={steps.categories.household[1].title}
            onClick={(): void => {
              toggleStep();
              setActive(1);
            }}
        ...
        <div className="flex justify-center col-start-4">
          <StoryButton
            className="transition-transform hover:scale-125"
            color="#4F7EBA"
            text={steps.categories.household[2].title}
            onClick={(): void => {
              toggleStep();
              setActive(2);
            }}
        ...
        <div className="flex justify-center col-start-1">
          <StoryButton
            className="transition-transform hover:scale-125"
            color="#4F7EBA"
            text={steps.categories.household[3].title}
            onClick={(): void => {
              toggleStep();
              setActive(3);
            }}
        ...
        <div className="flex justify-center col-start-5">
          <StoryButton
            className="transition-transform hover:scale-125"
            color="#4F7EBA"
            text={steps.categories.household[4].title}
            onClick={(): void => {
              toggleStep();
              setActive(4);
            }}
        ...
        <div className="flex justify-center col-start-1">
          <StoryButton
            className="transition-transform hover:scale-125"
            color="#4F7EBA"
            text={steps.categories.household[5].title}
            onClick={(): void => {
              toggleStep();
              setActive(5);
            }}
        ...
        <div className="flex justify-center col-start-5">
          <StoryButton
            className="transition-transform hover:scale-125"
            color="#4F7EBA"
            text={steps.categories.household[6].title}
            onClick={(): void => {
              toggleStep();
              setActive(6);
            }}
        ...
        <div className="flex justify-center col-start-2">
          <StoryButton
            className="transition-transform hover:scale-125"
            color="#4F7EBA"
            text={steps.categories.household[7].title}
            onClick={(): void => {
              toggleStep();
              setActive(7);
            }}
        ...
        <div className="flex justify-center col-start-4">
          <StoryButton
            className="transition-transform hover:scale-125"
            color="#4F7EBA"
            text={steps.categories.household[8].title}
            onClick={(): void => {
              toggleStep();
              setActive(8);
            }}
        ...
        <div className="flex justify-center col-start-3">
          <StoryButton
            className="transition-transform hover:scale-125"
            color="#4F7EBA"
            text={steps.categories.household[9].title}
            onClick={(): void => {
              toggleStep();
              setActive(9);
            }}
